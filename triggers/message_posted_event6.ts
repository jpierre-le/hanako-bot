...
const trigger: Trigger<typeof ReplyToMessageWorkflow6.definition> = {
  ...
  name: "Reply to the posted message6",
  workflow: `#/workflows/${ReplyToMessageWorkflow6.definition.callback_id}`,
  inputs: {
    message_ts: {
